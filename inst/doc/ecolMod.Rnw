...
#
persp(gg,col=drapecol(gg,col),border=NA,theta=30,phi=30, axes=TRUE,
  box=TRUE, lty=2,xlab="parameter 1", ylab="parameter 2",
  zlab="cost",ticktype="simple",cex=1.5)
#
...
#
equation2 <- function(ini,i1=5,a=-1,b=1,e=-1,f=-1,endt=100,dt=0.1,...) {
  times <- seq(0,endt,dt)
...
\begin{figure}
\begin{center}
<<label=chap7,fig=TRUE,echo=FALSE,width=10,height=5>>=
<<chap7>>
@
\end{center}
